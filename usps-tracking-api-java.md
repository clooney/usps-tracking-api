...
================================
Use Java to track USPS shipments with USPS Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.usps;
    ...
    public class CreateUSPSTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("9400111899562537683144");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateUSPSTrackingsExample {
...
Get status of the shipment:
    ...
    public class GetUSPSTrackingExample {
...
Update a tracking by ID:
    ...
    public class UpdateUSPSTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "9a1d3844a50f3851e76e3ee347881588";
